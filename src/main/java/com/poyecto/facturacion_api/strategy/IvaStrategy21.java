...
/**
 * Implementación de la estrategia para el cálculo de IVA al 21%
 */
public class IvaStrategy21 implements ImpuestoStrategy {
    
    private static final BigDecimal PORCENTAJE = new BigDecimal("21");
