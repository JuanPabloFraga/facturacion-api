...
/**
 * Implementación de la estrategia para el cálculo de IVA al 10.5%
 */
public class IvaStrategy105 implements ImpuestoStrategy {
    
    private static final BigDecimal PORCENTAJE = new BigDecimal("10.5");
